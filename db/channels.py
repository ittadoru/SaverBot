"""Модель каналов и фича-флагов + CRUD и утилиты проверки подписки."""
...
async def check_user_memberships(bot, user_id: int, channels: Sequence[Channel]) -> list[ChannelCheckResult]:
